...
title-slide-attributes:
  data-background-image: "assets/nexer-og.png"
...
Versus the first industrializing country 🇬🇧 and South Africa 🇿🇦
...
## Why did Sweden become rich🇸🇪?{visibility="uncounted" transition="none"}
...
| `birth_details.place`          | `Hille, Gävleborgs län`      | `Hille, Gävle County`     | 0  | 1  | 1  | **Incorrect**: Similar but not an exact match. Scored as a miss and a mistake. |
